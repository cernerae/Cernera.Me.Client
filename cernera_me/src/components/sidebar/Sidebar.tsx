...
const Sidebar = ({
  ...
  const aboutPageSelected: boolean | "" | undefined =
    user && location.pathname.endsWith(user.name);
  const projectsPageSelected: boolean | "" | undefined =
    location.pathname.endsWith("projects");
  const resumePageSelected: boolean | "" | undefined =
    location.pathname.endsWith("resume");
  const contactPageSelected: boolean | "" | undefined =
        ...
        <div className={style[`sidebar__${sidebarType}__menu`]}>
          <div className={style[`sidebar__${sidebarType}__menu__main`]}>
            ...
            >
              {!isHomeItemHovered ? (
                <>
                  <FontAwesomeIcon
                    className={style[sidebarMenuItemIconClass]}
                    icon={["fas", "home"]}
                  />
                </>
              ) : (
            ...
            {user.showProjects ? (
              ...
              >
                {!projectsPageSelected && !isProjectsItemHovered ? (
                  ...
                  <div className={style[sidebarMenuItemLabelClass]}>
                    Projects
                  </div>
                )}
              </div>
          ...
          <div className={style[`sidebar__${sidebarType}__menu__footer`]}>
            {user.socialMedia.github !== undefined ? (
              <a
                href={`https://www.github.com/${user.socialMedia.github}`}
                target="_blank"
                rel="noopener noreferrer"
              >
                <div
                  className={
                    style[`sidebar__${sidebarType}__menu__footer__menu-item`]
                  }
                >
            ...
            {user.socialMedia.linkedin !== undefined ? (
              <a
                href={`https://www.linkedin.com/in/${user.socialMedia.linkedin}`}
                target="_blank"
                rel="noopener noreferrer"
              >
                <div
