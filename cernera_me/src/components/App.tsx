...
import { socialUsernames, socialUsernamesGregory, contactGregory, contactEdward, 
         educationGregory, experienceGregory, educationEdward, experienceEdward } from "info/userInfo";
