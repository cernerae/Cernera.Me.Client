...
import { socialUsernames, socialUsernamesGregory, socialUsernamesRobert, socialUsernamesThomas,
         ...
         educationThomas, experienceThomas, publicationsRobert} from "info/userInfo";
    ...
    <div className={styles["App"]}>
      <Router>
        <Switch>
          ...
          <Route path="/edward/resume" component={() => <ResumeForm user={"edward"} social={socialUsernames} experience={experienceEdward} education={educationEdward} publications={null}/>} />
          ...
          <Route path="/gregory/resume" component={() => <ResumeForm user={"gregory"} social={socialUsernamesGregory} experience={experienceGregory} education={educationGregory} publications={null}/>} />
          ...
          <Route path="/robert/resume" component={() => <ResumeForm user={"robert"} social={socialUsernamesRobert} experience={experienceRobert} education={educationRobert} publications={publicationsRobert}/>} />
          ...
          <Route path="/thomas/resume" component={() => <ResumeForm user={"thomas"} social={socialUsernamesThomas} experience={experienceThomas} education={educationThomas} publications={null}/>} />
