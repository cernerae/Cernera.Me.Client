...
const UserLandingPage = ({ username, allUsers }: { username: string, allUsers: UserInfoType[] }) => {
    ...
    return (
        <>
            {user ?
                <div id="UserLandingPage" className={[landingStyles["landing-page"], landingStyles["user-landing-page"]].join(' ')}>
                    <Sidebar sm={true} slideIn={true} user={user} />
                    <div className={[landingStyles["landing-page__content"], styles["user-landing-page"]].join(" ")} style={{ paddingLeft: "30px" }}>
                        <Container className={landingStyles["landing-page__content__container"]}>
                            <Row className={landingStyles["landing-page__content__container__content"]}>
                                ...
                                <Col md={12} lg={6} className={[genStyle["vertical-center"], "w-100", styles["tech-images"]].join(' ')}>
